...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string anotherPet = "y"; // assumes that we want to add a new animal
            int petCount = 0; // counter

            for (int i = 0; i < maxPets; i++) // checks how many animals we have
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    petCount += 1;
            ...
            if (petCount < maxPets) // print out info about amout animals
            {
                Console.WriteLine(
            ...
            while (anotherPet == "y" && petCount < maxPets) // adding another pet
            {
                ...
                petCount = petCount + 1; // increment petCount with added animal
